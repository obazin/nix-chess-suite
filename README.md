...
|---|---|---|
| `x86_64-linux` | Nix flake | supported |
| `aarch64-linux` | Nix flake | supported |
| `aarch64-darwin` | Nix flake | supported |
| `x86_64-windows` | GitHub Actions, MSYS2/mingw | supported, not Nix-managed |
